...
class ForwardSDMolSupplier:
    ...
    @classmethod
    def GetEOFHitOnRead(cls, Any) -> Any: ...
    @classmethod
    def GetProcessPropertyLists(cls, Any) -> Any: ...
    @classmethod
    def SetProcessPropertyLists(cls, Any, bool) -> Any: ...
    @classmethod
    def atEnd(cls, Any) -> Any: ...
    @classmethod
    def __enter__(cls, Any) -> Any: ...
    @classmethod
    def __exit__(cls, type, value, traceback) -> Any: ...
    @classmethod
    def __iter__(cls, Any) -> Any: ...
    @classmethod
    def __next__(cls, Any) -> Any: ...
    @classmethod
